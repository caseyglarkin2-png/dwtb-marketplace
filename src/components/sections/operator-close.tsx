      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 border border-border rounded-lg text-text-primary hover:border-accent hover:text-accent transition-colors"
          >
